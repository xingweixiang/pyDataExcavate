...
## 三、[数据探索](/example/chapter3/demo)（代码）
...
## 四、[数据预处理](/example/chapter4/demo)（代码）
...
## 五、[挖掘建模](/example/chapter5/demo)（代码）
...
## 六、[电力窃漏电用户自动识别](/example/chapter6/demo)（代码）
### 1、背景与挖掘目标
...
## 七、[航空公司客户价值分析](/example/chapter7/demo)（代码）
### 7-1、背景与挖掘目标
...
## 八、[中医证型关联规则挖掘](/example/chapter8/demo)（代码）
### 8-1、背景与挖掘目标
...
## 九、[基于水色图像的水质评价](/example/chapter9/demo)（代码）
### 9-1、背景与挖掘目标
...
## 十二、[电子商务网站用户行为分析及服务推荐](/example/chapter12/demo)（代码）
### 12-1、背景与挖掘目标
- 
### 12-2、数据探索分析及数据预处理
- 
### 12-3、模型构建
- 
## 十三、[财政收入影响因素分析及预测模型](/example/chapter13/demo)（代码）
### 13-1、背景与挖掘目标
- 
### 13-2、数据探索分析及数据预处理
- 
### 13-3、模型构建
- 
## 十四、[基于基站定位数据的商圈分析](/example/chapter14/demo)（代码）
### 14-1、背景与挖掘目标
- 
### 14-2、数据探索分析及数据预处理
- 
### 14-3、模型构建
- 
## 十五、[电商产品评论数据情感分析](/example/chapter15/demo)（代码）
### 15-1、背景与挖掘目标
- 
### 15-2、数据探索分析及数据预处理
- 
